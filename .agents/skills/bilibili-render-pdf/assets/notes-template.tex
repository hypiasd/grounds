...
% Basic packages
% Fandol is a free CJK font set; it lacks some specialized Chinese characters
% (e.g., 「昇」「騰」in 昇騰/昇思). On macOS prefer fontset=mac; on other
% platforms the missing glyphs render as blank. Switch fontset if needed.

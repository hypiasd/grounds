...
% falls back to fandol (free CJK; may lack 「昇」「騰」on non-macOS).
% Override by editing fontset= manually if auto-detection picks wrong.
\usepackage[fontset=\IfFileExists{/System/Library/Fonts/PingFang.ttc}{mac}{fandol}]{ctex}

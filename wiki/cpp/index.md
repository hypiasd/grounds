...
- [LeetCode C++ 常用写法](leetcode.md) — 把 STL/lambda/引用等机制组合成刷题代码的实战写法：堆/二分/位运算/浮点精度/迭代器失效/有序容器/链表技巧七方向，每方向给可搬写法+坑
...
- **力扣实战写法**: [LeetCode C++ 常用写法](leetcode.md) — 语言机制层的"组合应用层"：把 [STL](stl.md)/[Lambda](lambda.md)/[unordered_set](unordered-set.md)/[Value Initialization](value-initialization.md) 等笔记的能力拼成解题代码；仓库现有 21 篇是机制，这篇是用法
